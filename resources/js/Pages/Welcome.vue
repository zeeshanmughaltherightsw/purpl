...
<template>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 shadow">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse countainer">
            <Link :href="route('welcome')" class="nav-item nav-link active">Home</Link>
        </div>
        <Link as="button" text="Sign in" :href="route('login')" type="button" class="btn btn-primary sign mx-3 px-4">Sign in</Link>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Stonearn</a>, All Right Reserved.
                </div>
            </div>
        </div>
    </div>

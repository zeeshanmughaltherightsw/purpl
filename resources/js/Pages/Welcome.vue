  ...
  <GuestLayout>
    ...
    <center>
      ...
      <div class="row container">
        <PlanCard title="Basic" price="50$" planType="Investors" />
        <PlanCard title="STARTER" price="100$" planType="Investors" />
        <PlanCard title="Sliver" price="500$" planType="Investors" />
        ...
        <div class="col-md-3 solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <button type="button" class="read_more_btn my-3">
                Uprade Now
              </button>
            </div>
          </div>
            ...
            <div class="row g-5">
              <div class="col-12 col-sm-6 col-lg-12">
                <div class="border-start ps-4">
                  ...
                  <span
                    >Indeed, Stonearn is an award-winning company that works
              ...
              <div class="col-12 col-sm-6 col-lg-12">
                <div class="border-start ps-4">
                  ...
                  <span
                    >For Stone mining and jewelry designs, we have a dedicated
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item rounded d-flex h-100">
              <div class="service-img rounded">
                <img
                  class="img-fluid"
                  src="img/services/services-8.jpg"
                  alt=""
                />
              </div>
              <div class="service-text rounded p-5">
